  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-6 left-6 z-50 w-14 h-14 rounded-full bg-red-600 shadow-lg flex items-center justify-center animate-pulse hover:scale-110 transition-transform ${isOpen ? "hidden" : ""}`}
