...
export const products: Product[] = [
  ...
  },
  {
    ...
    variants: [
      { color: "weiss", artNr: "SIM010", image: null, name: "Flächenset 40 Weiß" },
      {
        color: "anthrazit",
        artNr: "SIM009",
        image: null,
  ...
  },
  {
    ...
    colors: ["weiss", "anthrazit"],
    variants: [
      { color: "weiss", artNr: "SIM011", image: null, name: "Flächenset 80 Weiß" },
      { color: "anthrazit", artNr: "SIM012", image: null, name: "Flächenset 80 Schwarz" },
    ],
  },
  {
