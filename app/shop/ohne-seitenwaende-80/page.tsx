...
import { ArrowLeft, ShoppingCart, Package, Check, Truck, RotateCcw, Award, ChevronRight, Layers, Maximize, Layout, ArrowLeftRight } from "lucide-react"
...
const product = {
  ...
  name: "Ohne Seitenwände 80",
  fullName: "Modul ohne seitliche Begrenzung",
  artNr: "MOD-80-002",
  description: "Das Modul ohne Seitenwände ermöglicht eine durchgehende Optik bei mehreren nebeneinander platzierten Modulen. Ideal für lange Regalreihen und offene Raumgestaltung.",
  shortDescription: "Für durchgehende Regale und offene Raumgestaltung.",
  price: 32.0,
  category: "80er",
  moduleType: "ohne-seitenwaende",
  width: 80,
  features: [
    { icon: ArrowLeftRight, title: "Durchgehende Optik", description: "Nahtloser Übergang zwischen Modulen" },
    { icon: Layout, title: "Flexible Kombination", description: "Perfekt für lange Regalreihen" },
    { icon: Maximize, title: "Maximale Breite", description: "Nutzt die volle Breite ohne Unterbrechung" },
  ...
  specs: [
    ...
    { label: "Belastbarkeit", value: "30 kg" },
  ],
}
...
const colorPrices: Record<string, number> = { white: 0, grey: 0, black: 0, blue: 15, green: 15, yellow: 15, orange: 15, red: 15 }

export default function OhneSeitenwaendeProductPage() {
