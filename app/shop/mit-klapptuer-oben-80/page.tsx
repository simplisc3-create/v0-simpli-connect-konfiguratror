...
import { ArrowLeft, ShoppingCart, Package, Check, Truck, RotateCcw, Award, ChevronRight, ChevronUp, Sparkles, Wind, Layers } from "lucide-react"
...
const product = {
  ...
  name: "Klapptür (oben) 80",
  fullName: "Modul mit nach oben öffnender Klapptür",
  artNr: "MOD-80-007",
  description: "Das elegante Modul mit nach oben öffnender Klapptür mit Gasfeder-Unterstützung. Die Tür bleibt offen stehen und schließt sich sanft. Ideal für obere Regalfächer oder wenn darunter Platz benötigt wird.",
  shortDescription: "Nach oben öffnend mit Gasfeder-Unterstützung.",
  price: 58.0,
  category: "80er",
  moduleType: "mit-klapptuer-oben",
  width: 80,
  features: [
    { icon: ChevronUp, title: "Klapptür nach oben", description: "Öffnet nach oben für freien Zugang" },
    { icon: Wind, title: "Gasfeder", description: "Sanftes Öffnen und Schließen" },
    { icon: Sparkles, title: "Bleibt offen", description: "Tür hält in offener Position" },
  ...
  specs: [
    ...
    { label: "Türtyp", value: "Klapptür (oben)" },
    { label: "Mechanik", value: "Gasfeder" },
...
export default function MitKlapptuerObenProductPage() {
