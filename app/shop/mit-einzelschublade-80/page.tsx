...
const product = {
  ...
  name: "Einzelschublade 80",
  fullName: "Modul mit einer Vollauszug-Schublade",
  artNr: "MOD-80-009",
  description: "Das kompakte Schubladenmodul mit einer geräumigen Vollauszug-Schublade. Ideal wenn Sie eine einzelne, tiefe Schublade für größere Gegenstände benötigen. Mit Soft-Close-Funktion für sanftes Schließen.",
  shortDescription: "Kompakter Stauraum für einzelne Fächer.",
  price: 48.0,
  category: "80er",
  moduleType: "mit-einzelschublade",
  width: 80,
  features: [
    { icon: Archive, title: "Eine Schublade", description: "Tiefe Schublade für größere Gegenstände" },
    { icon: Minimize, title: "Kompakt", description: "Ideal für einzelne Fächer im Regal" },
  ...
  specs: [
    ...
    { label: "Schubladen", value: "1 Stück" },
...
export default function MitEinzelschubladeProductPage() {
