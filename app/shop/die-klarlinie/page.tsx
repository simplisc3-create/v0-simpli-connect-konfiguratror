...
const regal = productsSimpliRegale.find(r => r.id === "die-klarlinie")!
const calculatedPrice = regal.preset ? calculatePresetPrice(regal.preset) : calculatedPrice

export default function DieKlarlinieProductPage() {
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-wrap gap-2">
                {regal.features.map((feature, idx) => (
                  <span key={idx} className="px-3 py-1.5 bg-gray-100 text-gray-700 text-sm font-medium">
                    {feature}
                  </span>
                ))}
              </div>
