...
const regal = productsSimpliRegale.find(r => r.id === "der-showtower")!
const calculatedPrice = regal.preset ? calculatePresetPrice(regal.preset) : calculatedPrice

export default function DerShowtowerProductPage() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-4">
              ...
              <Link href="/konfigurator?preset=der-showtower" className="block">
