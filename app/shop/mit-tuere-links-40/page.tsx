...
const product = {
  ...
  name: "Mit Türe Links 40",
  fullName: "Kompaktes Modul mit Türe (Linksanschlag)",
  artNr: "MOD-40-005",
  description: "Das kompakte Modul mit eleganter Türe und Linksanschlag im praktischen 40cm Format. Die hochwertige Soft-Close-Funktion sorgt für sanftes, geräuschloses Schließen. Ideal für die linksseitige Anordnung in Ihrem Regalsystem - perfekt für die geschützte Aufbewahrung von Dokumenten, Büchern oder persönlichen Gegenständen.",
  shortDescription: "Elegante Türe mit Linksanschlag und Soft-Close.",
  price: 65.0,
  category: "40er",
  moduleType: "mit-tuere-links",
  width: 40,
  features: [
    { icon: DoorOpen, title: "Linksanschlag", description: "Türe öffnet komfortabel nach links" },
    { icon: Shield, title: "Geschützt", description: "Inhalte sicher vor Staub und Blicken" },
    { icon: Volume2, title: "Soft-Close", description: "Sanftes, geräuschloses Schließen" },
    { icon: Settings, title: "Justierbar", description: "Scharniere individuell einstellbar" },
  ],
  specs: [
...
const relatedProducts = [
  ...
  { id: "abschliessbar-links-40", name: "Abschließbar Links 40", price: 75.0, moduleType: "abschliessbar-links" },
]
...
export default function MitTuereLinks40ProductPage() {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none text-gray-600 space-y-4">
          ...
          <p>
            Das Mit Türe Links 40 Modul ist die perfekte Ergänzung für Ihr modulares Regalsystem. Dank des 
            kompakten 40cm Formats eignet es sich ideal für kleinere Räume oder als Akzentmodul in größeren 
            Konfigurationen. Der Linksanschlag ermöglicht eine ergonomische Anordnung, besonders in Kombination 
            mit dem Mit Türe Rechts 40 Modul für symmetrische Designs.
          </p>
          <p>
            Die hochwertige Soft-Close-Technologie sorgt für sanftes und geräuschloses Schließen der Türe. 
            Die justierbaren Scharniere garantieren eine perfekte Ausrichtung auch nach Jahren intensiver 
            Nutzung. Der pulverbeschichtete Korpus ist in sieben attraktiven Farben erhältlich und fügt 
