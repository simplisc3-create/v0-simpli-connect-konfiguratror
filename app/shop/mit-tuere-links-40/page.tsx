...
const PRODUCT = {
  ...
  name: "Mit Tuere Links 40",
  shortName: "Tuer L",
  description: "Kompaktes Modul mit Tuer und Linksanschlag - perfekt fuer geschuetzte Aufbewahrung.",
  basePrice: 65,
  sku: "MOD-040-003",
  moduleType: "mit-tuere-links",
  width: 40,
  features: [
    { icon: DoorOpen, title: "Linksanschlag", desc: "Tuer oeffnet nach links" },
...
export default function MitTuereLinks40Page() {
