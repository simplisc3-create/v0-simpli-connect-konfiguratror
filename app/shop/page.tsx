...
const products = [
  ...
  },
  {
    ...
    name: "Flächenset 40",
    artNr: "SIM009/SIM010",
    description: "Regalböden 40cm (9 Stück) - Verfügbar in Weiß und Schwarz",
    price: 15.0,
    category: "flaechen",
    image: "/white-shelf-panels-40cm-pack.jpg",
    variants: [
      { color: "weiss", artNr: "SIM010", image: "/white-shelf-panels-40cm-pack.jpg" },
      { color: "anthrazit", artNr: "SIM009", image: "/black-shelf-panels-40cm-pack.jpg" },
    ],
  },
  {
    id: "flaechenset-80",
    name: "Flächenset 80",
    artNr: "SIM011/SIM012",
    description: "Regalböden 80cm (11 Stück) - Verfügbar in Weiß und Schwarz",
    price: 22.0,
    category: "flaechen",
    image: "/white-shelf-panels-80cm-pack.jpg",
    variants: [
      { color: "weiss", artNr: "SIM011", image: "/white-shelf-panels-80cm-pack.jpg" },
      { color: "anthrazit", artNr: "SIM012", image: "/black-shelf-panels-80cm-pack.jpg" },
    ],
  },
  {
    ...
    price: 85.0,
    category: "module",
    image: "/images/schublade.jpg", // Updated to correct blob storage URL
  },
  {
    id: "tuer-40-weiss",
    name: "Tür 40cm Weiß",
