...
import { ArrowLeft, ShoppingCart, Package, Check, Truck, RotateCcw, Award, ChevronRight, DoorOpen, Sparkles, ShieldCheck, Layers } from "lucide-react"
...
const product = {
  id: "mit-tueren",
  name: "Mit Türen 80",
  fullName: "Modul mit Doppeltüren",
  artNr: "MOD-80-005",
  description: "Das klassische Schrankmodul mit zwei eleganten Türen. Verstecken Sie Ordner, Technik oder persönliche Gegenstände hinter den geschlossenen Türen. Soft-Close-Scharniere sorgen für ein sanftes, leises Schließen.",
  shortDescription: "Stauraum mit elegantem Verschluss.",
  price: 65.0,
  category: "80er",
  moduleType: "mit-tueren",
  width: 80,
  features: [
    { icon: DoorOpen, title: "Doppeltüren", description: "Zwei Türen für vollständigen Zugang" },
    { icon: Sparkles, title: "Soft-Close", description: "Gedämpfte Scharniere für leises Schließen" },
    { icon: ShieldCheck, title: "Versteckter Stauraum", description: "Ordnung hinter geschlossenen Türen" },
...
export default function MitTuerenProductPage() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div className="relative">
            <div className="absolute top-4 left-4 z-20">
              <Badge className="bg-blue-600 text-white border-0 px-3 py-1.5 text-xs font-semibold tracking-wide">KLASSIKER</Badge>
            </div>
