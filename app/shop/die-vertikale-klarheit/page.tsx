...
const regal = productsSimpliRegale.find(r => r.id === "die-vertikale-klarheit")!

export default function DieVertikaleKlarheitProductPage() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-4">
              ...
              <Link href="/konfigurator?preset=die-vertikale-klarheit" className="block">
