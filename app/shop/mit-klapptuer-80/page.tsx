...
import { ArrowLeft, ShoppingCart, Package, Check, Truck, RotateCcw, Award, ChevronRight, ChevronDown, Sparkles, Maximize, Layers } from "lucide-react"
...
const product = {
  id: "mit-klapptuer",
  name: "Mit Klapptür 80",
  fullName: "Modul mit nach unten öffnender Klapptür",
  artNr: "MOD-80-006",
  description: "Das platzsparende Modul mit nach unten öffnender Klapptür. Perfekt für beengte Räume oder wenn darüber Gegenstände stehen. Die Soft-Close-Scharniere sorgen für sanftes Schließen.",
  shortDescription: "Platzsparend mit Soft-Close-Scharnieren.",
  price: 55.0,
  category: "80er",
  moduleType: "mit-klapptuer",
  width: 80,
  features: [
    { icon: ChevronDown, title: "Klapptür nach unten", description: "Öffnet nach unten für besseren Zugang" },
    { icon: Sparkles, title: "Soft-Close", description: "Gedämpfte Scharniere für leises Schließen" },
    { icon: Maximize, title: "Platzsparend", description: "Keine seitlich ausschwingende Tür" },
  ...
  specs: [
    ...
    { label: "Türtyp", value: "Klapptür (unten)" },
    { label: "Scharniere", value: "Soft-Close" },
...
export default function MitKlapptuerProductPage() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div className="relative">
            <div className="absolute top-4 left-4 z-20">
              <Badge variant="secondary" className="bg-gray-100 text-gray-700 border-0 px-3 py-1.5 text-xs font-semibold tracking-wide">80er Modul</Badge>
            </div>
