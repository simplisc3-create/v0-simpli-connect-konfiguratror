...
import { ShoppingCart, Check, Package, ArrowLeft, Truck, RotateCcw, Shield, DoorOpen, Box, Ruler } from "lucide-react"
...
const PRODUCT = {
  ...
  name: "Mit Tuere Rechts 40",
  shortName: "Tuer R",
  description: "Kompaktes Modul mit Tuer und Rechtsanschlag - perfekt fuer geschuetzte Aufbewahrung.",
  basePrice: 65,
  sku: "MOD-040-002",
  moduleType: "mit-tuere-rechts",
  width: 40,
  features: [
    { icon: DoorOpen, title: "Rechtsanschlag", desc: "Tuer oeffnet nach rechts" },
    { icon: Shield, title: "Geschuetzt", desc: "Inhalte sicher verwahrt" },
    { icon: Ruler, title: "Kompakt", desc: "40 x 40 x 40 cm" },
    { icon: Box, title: "Soft-Close", desc: "Sanftes Schliessen" },
  ],
  specs: [
    { label: "Breite", value: "40 cm" },
    { label: "Hoehe", value: "40 cm" },
    { label: "Tiefe", value: "40 cm" },
    { label: "Tueranschlag", value: "Rechts" },
    { label: "Material Korpus", value: "MDF lackiert" },
    { label: "Material Rahmen", value: "Stahl verchromt" },
  ],
}

export default function MitTuereRechts40Page() {
