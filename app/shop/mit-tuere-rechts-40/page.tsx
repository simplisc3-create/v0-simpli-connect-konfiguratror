...
const product = {
  ...
  name: "Mit Türe Rechts 40",
  fullName: "Kompaktes Modul mit Türe (Rechtsanschlag)",
  artNr: "MOD-40-004",
  description:
    "Das kompakte Modul mit eleganter Türe und Rechtsanschlag im praktischen 40cm Format. Die hochwertige Soft-Close-Funktion sorgt für sanftes, geräuschloses Schließen. Perfekt für die geschützte Aufbewahrung von Dokumenten, Büchern oder persönlichen Gegenständen, die vor Staub und neugierigen Blicken geschützt werden sollen.",
  shortDescription: "Elegante Türe mit Rechtsanschlag und Soft-Close.",
  price: 65.0,
  category: "40er",
  moduleType: "mit-tuere-rechts",
  width: 40,
  features: [
    { icon: DoorOpen, title: "Rechtsanschlag", description: "Türe öffnet komfortabel nach rechts" },
  ...
  specs: [
    ...
    { label: "Türanschlag", value: "Rechts" },
...
const relatedProducts = [
  { id: "mit-tuere-links-40", name: "Mit Türe Links 40", price: 65, moduleType: "mit-tuere-links" },
...
export default function MitTuereRechts40ProductPage() {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none text-gray-600 space-y-4">
          ...
          <p>
            Der Rechtsanschlag der Türe ermöglicht eine optimale Platzierung im Regal - ideal, wenn Sie das Modul 
            auf der linken Seite Ihrer Konfiguration positionieren möchten. Die hochwertigen Scharniere mit 
            Soft-Close-Funktion garantieren ein sanftes, geräuschloses Schließen.
          </p>
          <p>
            Kombinieren Sie dieses Modul mit dem passenden "Mit Türe Links 40" für eine symmetrische Anordnung 
            oder mischen Sie es mit offenen Fächern für einen abwechslungsreichen Look. Das modulare Simpli Connect 
            System bietet unendliche Gestaltungsmöglichkeiten.
          </p>
        </div>
      </section>
