...
const PRODUCT = {
  ...
  shortName: "Offen",
  description: "Kompaktes offenes Regalmodul für schnellen Zugriff auf Ihre Lieblingsstücke.",
  basePrice: 45,
  sku: "MOD-040-001",
  moduleType: "offenes-fach",
  width: 40,
  features: [
    { icon: Box, title: "Offenes Design", desc: "Schneller Zugriff auf alle Inhalte" },
    { icon: Layers, title: "Stapelbar", desc: "Kombinierbar mit allen 40er Modulen" },
    { icon: Ruler, title: "Kompakt", desc: "40 x 40 x 40 cm" },
    { icon: Shield, title: "Stabil", desc: "Hochwertige Materialien" },
  ],
  specs: [
...
export default function OffenesFach40Page() {
          ...
          <div className="flex flex-col">
            <div className="space-y-6">
              ...
              <div className="flex items-baseline gap-3">
                ...
                {colorSurcharge > 0 && (
                  <span className="text-sm text-gray-500">(+{colorSurcharge} EUR Farbaufschlag)</span>
                )}
              </div>
              ...
              <div className="space-y-3">
                <label className="text-sm font-medium text-gray-700">
                  Farbe: {COLORS.find(c => c.id === selectedColor)?.name}
                </label>
            ...
            <div className="mt-8 space-y-3">
              <Button
                ...
                className={`w-full gap-2 text-lg py-6 ${
                  added ? "bg-green-600 hover:bg-green-600" : "bg-teal-600 hover:bg-teal-700"
                }`}
