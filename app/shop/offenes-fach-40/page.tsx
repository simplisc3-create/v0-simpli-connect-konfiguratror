...
const product = {
  ...
  fullName: "Kompaktes offenes Modul",
  artNr: "MOD-40-001",
  description:
    "Das kompakte offene Modul im 40cm Format - ideal für kleinere Räume oder als Ergänzung zu Ihrem bestehenden Regalsystem. Perfekt für Bücher, kleine Dekoartikel oder als Ablage für den täglichen Bedarf. Die offene Bauweise ermöglicht schnellen Zugriff und sorgt für ein luftiges Ambiente.",
  shortDescription: "Kompakt und vielseitig - für schnellen Zugriff.",
  price: 45.0,
  category: "40er",
  moduleType: "offenes-fach",
  width: 40,
  features: [
    { icon: Eye, title: "Schneller Zugriff", description: "Offene Gestaltung für sofortigen Zugang zu allen Gegenständen" },
    { icon: Layers, title: "Kompaktes Format", description: "40cm Breite - perfekt für kleinere Räume" },
    { icon: Maximize, title: "Flexibel kombinierbar", description: "Passt perfekt zu anderen 40er Modulen" },
    { icon: Feather, title: "Leichtes Design", description: "Modernes, luftiges Erscheinungsbild" },
  ],
  specs: [
...
const relatedProducts = [
  ...
  { id: "mit-tuere-links-40", name: "Mit Türe Links 40", price: 55.0, moduleType: "mit-tuere-links" },
  { id: "abschliessbar-links-40", name: "Abschliessbar 40", price: 75.0, moduleType: "abschliessbar-links" },
]

export default function OffenesFach40ProductPage() {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none text-gray-600">
          ...
          <p className="mt-4">
            Das offene 40er Modul ist der perfekte Einstieg in das Simpli Connect System. Es bietet maximale Flexibilität 
            bei minimalem Platzbedarf. Ob einzeln als kompakte Ablage oder in Kombination mit anderen Modulen - 
            dieses vielseitige Element fügt sich nahtlos in jede Umgebung ein.
          </p>
          <p className="mt-4">
            Die hochwertige Verarbeitung aus pulverbeschichtetem Metall garantiert Langlebigkeit und einfache Pflege. 
            Der verchromte Stahlrahmen verleiht dem Modul seinen charakteristischen, zeitlosen Look und sorgt für 
            optimale Stabilität im gesamten Regalsystem.
          </p>
        </div>
      </section>
