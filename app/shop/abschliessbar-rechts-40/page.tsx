...
const product = {
  ...
  name: "Abschließbar Rechts 40",
  fullName: "Kompaktes abschließbares Modul (Rechtsanschlag)",
  artNr: "MOD-40-007",
  description:
    "Das kompakte abschließbare Modul mit Rechtsanschlag im praktischen 40cm Format - maximale Sicherheit für Ihre Wertgegenstände. Das hochwertige Zylinderschloss schützt vertrauliche Dokumente, wertvolle Sammlerstücke oder persönliche Gegenstände zuverlässig. Zwei Schlüssel sind im Lieferumfang enthalten.",
  ...
  features: [
    ...
    { icon: KeyRound, title: "Rechtsanschlag", description: "Türe öffnet komfortabel nach rechts" },
  ],
  specs: [
...
const relatedProducts = [
  { id: "abschliessbar-links-40", name: "Abschließbar Links 40", price: 65.0, moduleType: "abschliessbar-links" },
...
export default function AbschliessbarRechts40ProductPage() {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none text-gray-600 space-y-4">
          ...
          <p>
            Das Abschließbar Rechts 40 Modul bietet maximale Sicherheit im kompakten 40cm Format. Das hochwertige
            Zylinderschloss schützt Ihre vertraulichen Dokumente, wertvollen Sammlerstücke oder persönlichen
            Gegenstände zuverlässig vor unbefugtem Zugriff. Der Rechtsanschlag ermöglicht eine ergonomische
