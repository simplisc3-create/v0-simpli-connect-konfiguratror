...
import { ArrowLeft, ShoppingCart, Package, Check, Truck, RotateCcw, Award, ChevronRight, Layers, Shield, Square, Sparkles } from "lucide-react"
...
const product = {
  id: "mit-rueckwand",
  name: "Mit Rückwand 80",
  fullName: "Modul mit geschlossener Rückwand",
  artNr: "MOD-80-004",
  description: "Das Modul mit Rückwand bietet einen aufgeräumten, geschlossenen Look. Perfekt für Wandmontage oder wenn Sie Kabel und Unordnung verbergen möchten. Die Rückwand verleiht zusätzliche Stabilität.",
  shortDescription: "Für einen aufgeräumten, geschlossenen Look.",
  price: 42.0,
  category: "80er",
  moduleType: "mit-rueckwand",
  width: 80,
  features: [
    { icon: Square, title: "Geschlossene Optik", description: "Aufgeräumtes Erscheinungsbild von hinten" },
    { icon: Shield, title: "Zusätzliche Stabilität", description: "Rückwand verstärkt die Konstruktion" },
    { icon: Sparkles, title: "Kabel verstecken", description: "Ideal um Unordnung zu verbergen" },
  ...
  specs: [
    ...
    { label: "Belastbarkeit", value: "35 kg" },
  ],
}
...
export default function MitRueckwandProductPage() {
