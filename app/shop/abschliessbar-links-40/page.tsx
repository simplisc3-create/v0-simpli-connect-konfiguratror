...
import { ShoppingCart, Check, Package, ArrowLeft, Truck, RotateCcw, Shield, Lock, Key, Ruler } from "lucide-react"
...
const PRODUCT = {
  ...
  name: "Abschliessbar Links 40",
  shortName: "Schloss L",
  description: "Kompaktes abschliessbares Modul mit Linksanschlag - maximale Sicherheit fuer Ihre Wertgegenstaende.",
  basePrice: 75,
  sku: "MOD-040-004",
  moduleType: "abschliessbar-links",
  width: 40,
  features: [
    { icon: Lock, title: "Abschliessbar", desc: "Hochwertiges Schloss" },
    { icon: Key, title: "2 Schluessel", desc: "Im Lieferumfang enthalten" },
    { icon: Ruler, title: "Kompakt", desc: "40 x 40 x 40 cm" },
    { icon: Shield, title: "Sicher", desc: "Fuer Wertgegenstaende" },
  ],
  specs: [
    { label: "Breite", value: "40 cm" },
    { label: "Hoehe", value: "40 cm" },
    { label: "Tiefe", value: "40 cm" },
    { label: "Tueranschlag", value: "Links" },
    { label: "Schloss", value: "Zylinderschloss" },
    { label: "Schluessel", value: "2 Stueck inklusive" },
  ],
}

export default function AbschliessbarLinks40Page() {
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-4">
            <div className="aspect-square bg-gray-50 rounded-2xl overflow-hidden relative">
              <Badge className="absolute top-4 left-4 z-10 bg-amber-600 text-white">Premium Sicherheit</Badge>
            ...
            <div className="space-y-6">
              ...
              <Tabs defaultValue="features" className="mt-6">
                <TabsList className="grid w-full grid-cols-2">
                  <TabsTrigger value="features">Sicherheit</TabsTrigger>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {PRODUCT.features.map((feature, i) => (
                      <div key={i} className="flex gap-3 p-3 bg-gray-50 rounded-lg">
                        <feature.icon className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
                        <div>
