...
const regal = productsSimpliRegale.find(r => r.id === "die-treppe")!
const calculatedPrice = regal.preset ? calculatePresetPrice(regal.preset) : calculatedPrice

export default function DieTreppeProductPage() {
  ...
  const specs = [
    ...
    { label: "Höhe max", value: `${regal.rows * 40} cm` },
    { label: "Tiefe", value: "40 cm" },
    { label: "Spalten", value: `${regal.cols}` },
    { label: "Ebenen (gestaffelt)", value: "1-4" },
    { label: "Modulbreite", value: `${regal.width} cm` },
    { label: "Material Rahmen", value: "Verchromter Stahl" },
  ]

  const features = [
    { icon: Grid3X3, title: "Gestaffelt", description: "1 bis 4 Ebenen aufsteigend" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-4">
              ...
              <Link href="/konfigurator?preset=die-treppe" className="block">
