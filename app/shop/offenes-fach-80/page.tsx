...
const product = {
  ...
  fullName: "Offenes Modul ohne Türen",
  artNr: "MOD-80-001",
  description:
    "Das klassische offene Modul für schnellen Zugriff auf alle Gegenstände. Perfekt für Bücher, Dekoration oder häufig genutzte Dinge. Die offene Gestaltung sorgt für ein luftiges Raumgefühl und macht Ihre Lieblingsstücke zum Blickfang.",
  shortDescription: "Perfekt für schnellen Zugriff und Dekoration.",
  price: 29.0,
  category: "80er",
  moduleType: "offenes-fach",
  width: 80,
  features: [
    { icon: Eye, title: "Alles im Blick", description: "Offene Gestaltung für schnellen Zugriff und Übersicht" },
    { icon: Layers, title: "Vielseitig einsetzbar", description: "Ideal für Bücher, Deko, Pflanzen und mehr" },
    { icon: Maximize, title: "Großzügiger Stauraum", description: "80cm Breite für optimale Raumnutzung" },
    { icon: Feather, title: "Leichte Optik", description: "Luftiges Design für moderne Einrichtungen" },
  ],
  specs: [
...
export default function OffenesFachProductPage() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div className="relative">
            <div className="absolute top-4 left-4 z-20">
              <Badge className="bg-teal-600 text-white border-0 px-3 py-1.5 text-xs font-semibold tracking-wide">
                BESTSELLER
              </Badge>
            </div>
