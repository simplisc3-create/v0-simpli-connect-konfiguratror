...
import { ArrowLeft, ShoppingCart, Package, Check, Truck, RotateCcw, Award, ChevronRight, Layers, Grid, Eye, Split } from "lucide-react"
...
const product = {
  id: "ohne-rueckwand",
  name: "Ohne Rückwand 80",
  fullName: "Modul ohne Rückwand - Raumteiler",
  artNr: "MOD-80-003",
  description: "Dieses Modul ohne Rückwand ist perfekt als Raumteiler geeignet. Beide Seiten sind zugänglich, was es ideal für offene Wohnkonzepte macht. Stellen Sie Bücher, Pflanzen oder Dekoration von beiden Seiten sichtbar aus.",
  shortDescription: "Ideal als Raumteiler mit beidseitigem Zugang.",
  price: 35.0,
  category: "80er",
  moduleType: "ohne-rueckwand",
  width: 80,
  features: [
    { icon: Split, title: "Raumteiler", description: "Perfekt zur Zonierung offener Räume" },
    { icon: Eye, title: "Beidseitig zugänglich", description: "Von beiden Seiten nutzbar" },
    { icon: Grid, title: "Durchsicht", description: "Lässt Licht durch den Raum fließen" },
...
export default function OhneRueckwandProductPage() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div className="relative">
            <div className="absolute top-4 left-4 z-20">
              <Badge className="bg-orange-500 text-white border-0 px-3 py-1.5 text-xs font-semibold tracking-wide">RAUMTEILER</Badge>
            </div>
