...
import { ShoppingCart, Check, Package, ArrowLeft, Truck, RotateCcw, Shield, Square, Box, Ruler } from "lucide-react"
...
const PRODUCT = {
  id: "mit-rueckwand-40",
  name: "Mit Rueckwand 40",
  shortName: "Rueckwand",
  description: "Geschlossene Rueckseite fuer einen sauberen, aufgeraeumten Look.",
  basePrice: 32,
  sku: "MOD-040-003",
  moduleType: "mit-rueckwand",
  width: 40,
  features: [
    { icon: Square, title: "Geschlossene Rueckwand", desc: "Sauberer Look von hinten" },
    { icon: Shield, title: "Staubschutz", desc: "Schuetzt Ihre Gegenstaende" },
    { icon: Ruler, title: "Kompakt", desc: "40 x 40 x 40 cm" },
    { icon: Box, title: "Vielseitig", desc: "Auch als Raumteiler" },
  ],
  specs: [
    ...
    { label: "Material Rueckwand", value: "MDF 6mm" },
    { label: "Max. Belastung", value: "15 kg" },
  ],
}

export default function MitRueckwand40Page() {
